...
public class ResourceCentreTest {
	...
	public void testAddChromebook() {
		...
		assertEquals("Test that Chrombook arrayList size is 1.",1,chromebookList.size());
		
		// Add an item
		ResourceCentre.addChromebook(chromebookList, cb2);
		assertEquals("Test that the Chromebook arrayList size is now 2.",2,chromebookList.size());
		//The item just added is as same as the last item in the list
		assertSame("Test that Chromebook is added to the end ot the list.",cb2,chromebookList.get(1));
